...
const Scan = props => {
  const {sendSMS, getSMS, deleteSMS, automatico} = props;
  const desccription =
    ...
    <View style={styles.scrollViewStyle}>
      ...
      <Fragment>
        ...
        <View style={styles.cardView}>
          ...
          <TouchableOpacity onPress={automatico} style={styles.buttonTouchable}>
            <Text style={styles.buttonTextStyle}> Enviar SMS !</Text>
          </TouchableOpacity>
          {/* <TouchableOpacity
            onPress={automatico}
